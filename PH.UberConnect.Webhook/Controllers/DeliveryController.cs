...
using PH.UberConnect.Webhook.Models;
using Serilog;
using System.Security.Cryptography;
using System.Text;
using System.Text.Json;

namespace PH.UberConnect.Webhook.Controllers
{
    ...
    public class DeliveryController : ControllerBase
    {
        ...
        public IActionResult UpdateStatus(object json)
        {
            try
            {
                ...
                var uberStatus = _services.DeliveryHistoryService.GetEventStatus(deliveryStatus!.status, deliveryStatus.id[^5..].ToUpper());
                ...
                rowsAffected = _services.DeliveryHistoryService.Insert(factura, uberStatus);
